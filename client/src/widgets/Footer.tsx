      ...
      >
        <Flex flexWrap="wrap" alignItems="start" justifyContent="space-between">
          <Box w={{ base: '100%', sm: '50%', md: 'max-content' }} mb={{ base: '1.5rem', lg: '0' }}>
            ...
            <List lineHeight="2" pl="0.2rem" justifyContent="center">
              <LinkItem text="О нас" />
              <LinkItem text="Политика конфиденциальности" />
              <LinkItem text="Пользовательское соглашение" />
              <LinkItem text="Вакансии" />
            </List>
          </Box>
          <Box w={{ base: '100%', sm: '50%', md: 'max-content' }} mb={{ base: '1.5rem', lg: '0' }}>
            <Heading as="h5" color="gray.700" mb="0.5rem" fontSize="0.875rem" fontWeight="600">
            ...
            <List lineHeight="2" pl="0.2rem">
              <LinkItem text="Как стать петситтером?" />
              <LinkItem text="Как получать оплату?" />
              <LinkItem text="Бонусная программа" isTag={true} tagText="New" />
              <LinkItem text="Стать амбассадором" />
            </List>
          </Box>
          <Box w={{ base: '100%', sm: '50%', md: 'max-content' }} mb={{ base: '1.5rem', lg: '0' }}>
            <Heading as="h5" color="gray.700" mb="0.5rem" fontSize="0.875rem" fontWeight="600">
            ...
            <List lineHeight="2" pl="0.2rem">
              <LinkItem text="Служба поддержки" />
              <LinkItem text="Как связаться с петситтером?" />
              <LinkItem text="Программа лояльности" isTag={true} tagText="New" />
              <LinkItem text="Подарочные карты" isTag={true} tagText="New" /> 
            </List>
          </Box>
          <Box w={{ base: '100%', sm: '50%', md: 'max-content' }} mb={{ base: '1.5rem', lg: '0' }}>
