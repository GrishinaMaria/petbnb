...
//   const cardBg = useColorModeValue("cyan.50", "cyan.50");
...
//   return (
//     <Container maxW="container.xl" py={8} verflowY="auto">
//       <VStack spacing={8} align="center">
//         <Heading py={4} size="2xl" color="#0BC5EA">
//           Чат
//         </Heading>
...
//! 2 вариант
import React, { useEffect, useState } from 'react';
import {Box,Container, HStack,Heading,Text,VStack,Divider,useColorModeValue,} from '@chakra-ui/react';
import useChat from '../../hooks/useChat';
import ChatComponent from '../chat/ui/ChatComponent';
import UsersList from '../chat/ui/UsersList';
import { useAppSelector } from '../../redux/hooks';
  ...
  return (
    <Container maxW="container.xl" py={8}>
      <VStack spacing={8} align="center">
        ...
        <Box w="full" p={4} bg={cardBg} borderRadius="lg" boxShadow="xl"overflowX="hidden" maxW="100%">
          <HStack spacing={4} align="flex-start">
            <Box
              w="25%"
              p={4}
              ...
              maxHeight="600px" // Устанавливаем максимальную высоту для контейнера с пользователями
              maxW="auto" // Устанавливаем максимальную ширину для контейнера
            >
              {loggedUser?.role === 'owner' && (
                <UsersList
                  users={sitters}
